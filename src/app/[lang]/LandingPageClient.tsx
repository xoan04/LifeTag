    ...
    return (
        <Box className="min-h-screen bg-gray-50 overflow-x-hidden font-sans">
            ...
            <Box className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 shadow-sm">
                <Container maxWidth="lg" className="flex justify-between items-center py-4">
                    <Typography variant="h5" fontWeight="900" color="primary" className="tracking-tighter flex items-center gap-2">
                    ...
                    <Box className="flex gap-4 items-center">
                        <Button
                            variant="text"
                            color="inherit"
                            className="font-bold text-gray-500 min-w-0 px-2"
                        ...
                        <Link href={`/${lang}/register`} style={{ textDecoration: 'none' }}>
                            <Button variant="contained" color="primary" className="rounded-full px-6 font-bold shadow-md hover:shadow-lg transition-all">
